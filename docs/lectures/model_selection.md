...
-   ![P(X)](https://latex.codecogs.com/png.latex?P%28X%29 "P(X)") is caled the **evidence**: ![P(X) = \\int P(X|\\theta) d \\theta](https://latex.codecogs.com/png.latex?P%28X%29%20%3D%20%5Cint%20P%28X%7C%5Ctheta%29%20d%20%5Ctheta "P(X) = \int P(X|\theta) d \theta") (in practice, this needs not to be calculated).
