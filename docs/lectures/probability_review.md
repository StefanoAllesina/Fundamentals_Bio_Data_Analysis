...
* Learn R tools for working with data 
* Become familiar with probability theory and assumptions of model
* Encounter and learn to avoid common statistical mistakes
* Apply this to your own data set

Course outline by week:

1. Review of probability, basic data visualization 
