...
```
    ...
    #           x         y
    # x 0.9908167 0.9408292
    # y 0.9408292 0.9926814
    #           x         y
    # x 0.9892976 0.9388112
    # y 0.9388112 0.9900007
...
```
    ...
    #           [,1]      [,2]
    # [1,] 0.9892976 0.9388112
    # [2,] 0.9388112 0.9900007
    #           x         y
    # x 0.9892976 0.9388112
    # y 0.9388112 0.9900007
    #      [,1] [,2]
...
```
    ...
    # List of 5
    #  $ sdev    : num [1:2] 1.389 0.225
    #  $ rotation: num [1:2, 1:2] -0.707 -0.707 0.707 -0.707
    #   ..- attr(*, "dimnames")=List of 2
    #   .. ..$ : chr [1:2] "x" "y"
    #   .. ..$ : chr [1:2] "PC1" "PC2"
    #  $ center  : Named num [1:2] 0.0389 0.0517
    #   ..- attr(*, "names")= chr [1:2] "x" "y"
    #  $ scale   : logi FALSE
    #  $ x       : num [1:500, 1:2] -0.562 -1.905 -2.121 1.464 -1.583 ...
    #   ..- attr(*, "dimnames")=List of 2
    #   .. ..$ : NULL
    #   .. ..$ : chr [1:2] "PC1" "PC2"
