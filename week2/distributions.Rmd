...
head(dt)
```
A simple way to visualize a distribution is to plot a histogram: data are binned, and the height of the bin represents counts (or frequencies). Plot the hisrograms of rhe four z-scores variables and visually assess what distribution they resemble.
