...
Now we can plot this data set on the world map, using the useful package maps, which you should install if you don't have it already. To plot use the usual ggplot() syntax with the following addition: `ggplot() +   mapWorld + ... `
